...
class TransFusionHead(nn.Module):
    ...
    def forward_single(self, inputs, metas):
        ...
        elif self.test_cfg['dataset'] == 'Omni3D':
        ...
        # small_cls_names = ["Pedestrian", "Cyclist", "Traffic_cone"]
        # for i, cls_name in enumerate(self.class_names):
        #     if cls_name in small_cls_names:
        #         local_max[:, i, ] = F.max_pool2d(
        #             heatmap[:, i, ], kernel_size=1, stride=1, padding=0)
    ...
    def get_targets_single(self, gt_instances_3d, preds_dict, batch_idx):
        ...
        #     grid_size[:2], self.train_cfg['out_size_factor'], rounding_mode='floor')  # [x_len, y_len]
