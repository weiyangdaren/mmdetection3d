...
// mean pooling
at::Tensor bev_mean_pool_forward(
    const at::Tensor _x,
    const at::Tensor _geom_feats,
    const at::Tensor _interval_lengths,
    const at::Tensor _interval_starts,
...
at::Tensor bev_mean_pool_backward(
    const at::Tensor _out_grad,
    const at::Tensor _geom_feats,
    const at::Tensor _interval_lengths,
    const at::Tensor _interval_starts,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("bev_pool_backward", &bev_pool_backward,
        "bev_pool_backward");
  m.def("bev_mean_pool_forward", &bev_mean_pool_forward,
        "bev_mean_pool_forward");
  m.def("bev_mean_pool_backward", &bev_mean_pool_backward,
        "bev_mean_pool_backward");
}
