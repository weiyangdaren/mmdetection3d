...
class DETR3DHead(DETRHead):
    ...
    def __init__(
        ...
        self.num_query = kwargs.get('num_query')
    ...
    def forward(self, mlvl_feats: List[Tensor], img_metas: List[Dict],
        ...
        hs, init_reference, inter_references = self.transformer(
            ...
            img_metas=img_metas,
            **kwargs)  # hs: [num_dec, bs, num_q, embed_dims]
        ...
        for lvl in range(hs.shape[0]):
            ...
            outputs_class = self.cls_branches[lvl](hs[lvl])  # shape: ([B, num_q, num_cls])
            tmp = self.reg_branches[lvl](hs[lvl])  # shape: ([B, num_q, 8])
